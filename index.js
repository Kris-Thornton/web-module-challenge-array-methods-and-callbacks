...
const getHomeTeamName = fifaData.filter((teamName) => {
    return teamName.Year === 2014 && teamName.Stage === 'Final'
  })
  console.log(`Task 1a`, getHomeTeamName)
//(a) Home Team name for 2014 world cup final


console.log(`Task 1b`, getHomeTeamName[0]['Away Team Name'])
//(b) Away Team name for 2014 world cup final


console.log(`Task 1c`, getHomeTeamName[0]['Home Team Goals'])
//(c) Home Team goals for 2014 world cup final


console.log(`Task 1d`, getHomeTeamName[0]['Away Team Goals'])
//(d) Away Team goals for 2014 world cup final

console.log(`Task 1d`, getHomeTeamName[0]['Win conditions'])
...
function getAverageGoals(data) {
    let goalsAveraged = data.reduce(function(acc, item){
        return acc + item['Home Team Goals'] + item['Away Team Goals'] 
    }, 0)
    return(goalsAveraged / data.length).toFixed(2);
 };
